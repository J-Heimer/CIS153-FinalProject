/**
 * Final Project - Bucket List App - PersonalGrowthItem Class
 * @author	Jon Heimer
 * @version 1.0
 * @since	1.0
 */
...
public class PersonalGrowthItem {
	// Members
	...
	public PersonalGrowthItem(String desc, int pri) {
		setCategory("Personal Growth");
		setDescription(desc);
		setPriority(pri);
		setTimestamp();
